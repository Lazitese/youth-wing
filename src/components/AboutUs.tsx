...
const AboutUs = () => {
 ...
 position: "የአቃቂ ቃሊቲ ክ/ ከተማ የብልጽግና ወጣት ክንፍ ጽ/ ቤት ኃላፊ",
      image: "/images/A3.jpg",
 message: "ብልፅግና ፓርቲ ከዚህ በፊት የነበሩ ስብራቶችን በመጠገን ህብረ ብሔራዊ እህትማማችነትና ወንድማማችነትን እያጎለበተ ያለ ፓርቲ ሲሆን በዚህ ሂደት ውስጥ የወጣቶች ሚና እጅግ የጎላ ነው።\nየዲሞክራሲ ስርዓትን ከማስፈን አኳያ የወጣቶች የዲሞክራሲ ስርዓት የሚጀምረው ቤትን በብቃትና በነፃነት በማስተዳደር በመሆኑ በፓርቲው የተቀመጠውን አቅጣጫ ለመተግበር አይቸገሩም።\nበፓርቲያችን 2ኛ መደበኛ ጉባኤ ከተቀመጡ አቅጣጫዎች ዋናው የዲሞክራሲ ስርዓት ግንባታን ማጎልበት ነው። በዚህ ሂደት ያላቸውን ልምድ ተጠቅመው በዲሞክራሲያዊ ስርዓት ግንባታ ላይ የበኩላቸውን ድርሻ ተወጥተዋል። በቀጣይም አጠናክረን እንቀጥላለን።\n\nበቀጣይ በአንድ በኩል ፓርቲው ያስቀመጠውን ዓበይት የጉባኤ አቅጣጫዎች በምልዓት ለመተግበር በሌላ አግባብ የወጣቶችን ተጠቃሚነት ይበልጥ የሚያጎለብቱ ተግባራት ማለትም በስራ እድል ፈጠራ፣ በሌማት ትሩፋት እና በሌሎች የገቢ ማስገኛ መንገዶች ሴቶችን ተጠቃሚ በማድረግ የብልጽግናን ጉዞ ለማፋጠን በርካታ እቅዶችን ስለያዝን መላው የክፍለ ከተማችን ሴቶች እንዲሁም የክንፉ አባላትን በማስተባበር ፓርቲያችን ያሰበዉን የብልጽግና ጉዞ እዉን እንዲሆን የበኩላችንን ድርሻ እንወጣለን።"
    }
  ];
