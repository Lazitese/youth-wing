...
const newsItems = [
  ...
  {
    id: 6,
    title: "የሴቶች አነስተኛ ብድር ፕሮግራም ተጀመረ",
    excerpt: "የሴቶች ኢኮኖሚያዊ ተሳትፎን ለማሳደግ የተዘጋጀ የብድር ፕሮግራም አቃቂ ቃሊቲ ክፍለ ከተማ ውስጥ ተጀመረ።",
    date: "ጥር 15, 2015",
  ...
  {
    id: 8,
    title: "የሴቶች ፖለቲካ ተሳትፎ ማሳደግ ውይይት ተካሄደ",
    excerpt: "የሴቶችን በፖለቲካ ውሳኔ አሰጣጥ ሂደቶች ተሳትፎ ለማሳደግ የሚረዳ ውይይት ተካሄደ።",
    date: "ታህሳስ 25, 2015",
    imageUrl: "https://images.unsplash.com/photo-1494172961521-33799ddd43a5",
    category: "ውይይት",
  },
...
const AllNews = () => {
  useEffect(() => {
    document.title = "ዜናዎች | የአቃቂ ቃሊቲ ክፍለ ከተማ ብልጽግና ፓርቲ ሴቶች ክንፍ";
    window.scrollTo(0, 0);
  }, []);
          ...
          <div className="flex flex-col md:flex-row justify-between items-start mb-12">
            <div>
              ...
              <p className="text-gray-600 max-w-2xl">
                ከአቃቂ ቃሊቲ ክፍለ ከተማ ብልጽግና ፓርቲ ሴቶች ክንፍ ቅርንጫፍ ጽ/ቤት የቅርብ ጊዜ ዜናዎች እና ማስታወቂያዎች
              </p>
            </div>
          </div>
