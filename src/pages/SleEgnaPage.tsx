...
const SleEgnaPage = () => {
  ...
  return (
    <div className="min-h-screen">
      ...
      {/* New Section: Mission of Women's Wing */}
      <section className="py-16 bg-gray-50">
        <div className="container-gov">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gov-dark mb-4 pt-4">
              <span className="text-gov-accent">የብልጽግና ሴቶች ክንፍ</span> ተልዕኮ
            </h2>
            <div className="w-24 h-1 bg-gov-accent mx-auto mb-4"></div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            {missionData.map((item, index) => (
              <div 
                key={index}
                className="bg-white rounded-lg shadow-md overflow-hidden transform transition-all duration-300 hover:-translate-y-1 hover:shadow-lg border border-gray-100"
              >
                <div className="flex items-start p-6">
                  <div className="bg-gov-accent/10 p-4 rounded-full mr-4">
                    <item.icon className="h-8 w-8 text-gov-accent" />
                  </div>
                  <div>
                    <h3 className="text-xl font-bold text-gov-dark mb-4">{item.title}</h3>
