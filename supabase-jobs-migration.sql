...
VALUES
  (
    ...
    'የሴቶች ክንፍ የሚዲያ እና ኮሙኒኬሽን ዘርፍ ለሚዲያ እና ኮሙኒኬሽን ስራ የሚሆን ባለሙያ ይፈልጋል። ይህ ባለሙያ የሚዲያ ይዘቶችን በማዘጋጀት፣ ማህበራዊ ሚዲያዎችን በማስተዳደር እና የውስጥ እና የውጭ ኮሙኒኬሽንን በማስተባበር ላይ ያተኩራል።',
...
የዜናዎችን ክትትል እና ትንተና ማድረግ',
  ...
  (
    'የፕሮጀክት አስተባባሪ',
    'የሴቶች ክንፍ የፕሮጀክት አስተባባሪ ለመቅጠር ይፈልጋል። ይህ አስተባባሪ የተለያዩ የሴቶች ማብቃት ፕሮጀክቶችን በማቀድ፣ በማስተባበር እና በመተግበር ላይ ያተኩራል።',
...
የፕሮጀክት ግምገማ ማድረግ',
  ...
  (
    ...
    'የሴቶች ክንፍ የአባላት ምዝገባ እና ክትትል ባለሙያ ይፈልጋል። ይህ ባለሙያ የአባላት ምዝገባን በማስተባበር፣ መረጃዎችን በማደራጀት እና ሪፖርቶችን በማዘጋጀት ላይ ያተኩራል።',
    'ቢያንስ ዲፕሎማ ወይም ዲግሪ
ጥሩ የመረጃ አያያዝ ክህሎት
